...
#define BLYNK_AUTH_TOKEN "Z51O6F5NRyBMHagbwSu5qquHPkaujzPa"  // <-- from Blynk device_hLmtVUUWlhtBanXKpviBJt0D_zIBJsA
...
// ---------- MQTT ----------
const char* mqtt_server = "10.13.44.27";  // Mosquitto / Cloud broker
